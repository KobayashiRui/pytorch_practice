...
def estimate(image_data):
    ...
    print("small : {}% , big : {}%".format(outputs.data[0][1]*100.0/total_data, outputs.data[0][0]*100.0/total_data))
...
model_ft.fc = nn.Linear(num_features,800) #これにより512->2の層に変わった
model_ft.add_module('relu_fc',nn.ReLU())
model_ft.add_module('fc2', nn.Linear(800,2))

param = torch.load('weight_resnet18_sb3.pth')
