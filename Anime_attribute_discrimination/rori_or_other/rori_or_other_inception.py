...
model_ft.add_module('relufc', nn.ReLU())
model_ft.add_module('doropoutfc', nn.Dropout())
model_ft.add_module('fc2', nn.Linear(500,2))
use_gpu = torch.cuda.is_available()
num_epochs = 200
criterion = nn.CrossEntropyLoss()
#optimizer = optim.SGD(model_ft.parameters(), lr=0.01,momentum=0.9)
optimizer = optim.Adam(model_ft.parameters(), lr=0.00002)
