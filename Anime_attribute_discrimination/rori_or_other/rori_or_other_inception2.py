...
#modelの作成
model_ft = models.inception_v3(pretrained=True) #このままだと1000クラス分類なので512->1000
#for param in model_ft.parameters():
#    param.requires_grad = False
num_features = model_ft.fc.in_features
print(num_features)
model_ft.fc = nn.Linear(num_features,1000) 
model_ft.add_module('relu_fc', nn.ReLU())
model_ft.add_module('fc2', nn.Linear(1000,500))
model_ft.add_module('relu_fc2', nn.ReLU())
model_ft.add_module('doropout_fc2',nn.Dropout())
model_ft.add_module('fc3', nn.Linear(500,100))
model_ft.add_module('relu_fc3', nn.ReLU())
model_ft.add_module('fc4', nn.Linear(100,2))
...
torch.save(model_ft.state_dict(),'weight_inception3.pth')
