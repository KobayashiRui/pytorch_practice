...
#modelの作成
model_ft = models.resnet34(pretrained=True) #このままだと1000クラス分類なので512->1000
#for param in model_ft.parameters():
#    param.requires_grad = False
num_features = model_ft.fc.in_features
model_ft.fc = nn.Linear(num_features,200) #これにより512->2の層に変わった
model_ft.add_module('relu_fc',nn.ReLU())
model_ft.add_module('fc2', nn.Linear(200,2))
...
torch.save(model_ft.state_dict(),'weight_resnet18_4.pth')
